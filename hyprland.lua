...
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.window.move({ direction = "l", into_group = "l", out_of_group = "l" }))
hl.bind(mainMod .. " + SHIFT + J", hl.dsp.window.move({ direction = "d", into_group = "d", out_of_group = "d" }))
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.window.move({ direction = "u", into_group = "u", out_of_group = "u" }))
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.window.move({ direction = "r", into_group = "r", out_of_group = "r" }))
